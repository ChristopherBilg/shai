...
# Generated completion files must carry the generator header; the fail-closed
# walker otherwise rejects them as unknown types.
mkdir -p "$FIX/completions"
printf '#compdef shai-version\n# Generated by shai-completions generate — do not edit manually\n' >"$FIX/completions/_shai"
printf '# Generated by shai-completions generate — do not edit manually\n' >"$FIX/completions/shai.bash"
printf '# something else entirely\n' >"$FIX/completions/hand-edited"

run_docs completions/_shai
assert_eq "$RC" "0" "completions/_shai: generator header passes"
assert_contains "$OUT" "generated completions:" "completions/_shai: prints its own classification"
run_docs completions/shai.bash
assert_eq "$RC" "0" "completions/shai.bash: generator header passes"
run_docs completions/hand-edited
assert_eq "$RC" "1" "completions/*: missing generator header fails"
assert_contains "$OUT" "Generated by shai-completions generate" "completions/*: names the missing header"
