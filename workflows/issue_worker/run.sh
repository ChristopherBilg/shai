...
# Reads: SHAI_API_KEY, SHAI_API_URL, SHAI_MODEL from environment; prompts/issue_worker.txt for LLM instructions
...
ISSUE_LABELS=$(printf '%s' "$ISSUE_LABELS" | jq -Rrs 'gsub("<\\s*/\\s*external_data\\s*>"; "&lt;/external_data&gt;"; "i") | gsub("&"; "\\&")')
